...
public enum ErrorCode {
    ...
    NOT_EXISTS_DEGREE(1012,"not exists degree" , HttpStatus.BAD_REQUEST),
    FULL_NAME_DEGREE_EXISTS(1013,"Tên đầy đủ đã tồn tại" , HttpStatus.BAD_REQUEST),
    SHORT_NAME_DEGREE_EXISTS(1014,"Tên viết tắt đã tồn tại " , HttpStatus.BAD_REQUEST),
